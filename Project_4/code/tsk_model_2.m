...
% TSK Model 2 -> class-independent + radius = 0.8 ("big")
...
fprintf('--- Class-Independent TSK Classification --- Model 2 ---\n');
...
for run = 1:numRuns
    ...
    radius = 0.8;  % Cluster radius (controls number of clusters/rules)
...
saveas(gcf, fullfile('TSK_model_2_imgs','2_MFsBeforeTraining.png'));
...
saveas(gcf, fullfile('TSK_model_2_imgs','2_MFsAfterTraining.png'));

% Confusion matrix heatmap
figure;
confusionchart(repRun.y_true, repRun.y_pred);
title('Confusion Matrix (Representative Run)');
saveas(gcf, fullfile('TSK_model_2_imgs','2_ConfusionMatrix.png'));
...
saveas(gcf, fullfile('TSK_model_2_imgs','2_PredictionErrors.png'));
...
saveas(gcf, fullfile('TSK_model_2_imgs','2_LearningCurve.png'));
