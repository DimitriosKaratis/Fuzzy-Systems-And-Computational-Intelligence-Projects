...
% TSK Model 4 -> class-dependent + radius = 0.8 ("big")
...
radius = 0.8;    % Cluster radius for subtractive clustering
allMetrics = cell(numRuns,1);

fprintf('--- Class-Dependent TSK Classification --- Model 4 --- \n');
...
saveas(gcf, fullfile('TSK_model_4_imgs','4_MFsBeforeTraining.png'));
...
saveas(gcf, fullfile('TSK_model_4_imgs','4_MFsAfterTraining.png'));

% Confusion matrix heatmap
figure;
confusionchart(repRun.y_true, repRun.y_pred);
title('Confusion Matrix (Representative Run)');
saveas(gcf, fullfile('TSK_model_4_imgs','4_ConfusionMatrix.png'));
...
saveas(gcf, fullfile('TSK_model_4_imgs','4_PredictionErrors.png'));
...
saveas(gcf, fullfile('TSK_model_4_imgs','4_LearningCurve.png'));
