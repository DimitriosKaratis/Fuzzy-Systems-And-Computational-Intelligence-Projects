...
% TSK Model 1 -> 2 MFs, Singleton output
...
fprintf('TSK Model 1 -> 2 MFs, Singleton output\n');
...
sgtitle('TSK model 1: MFs before Training')
saveas(gcf, 'TSK_model_1_imgs/1_MFs_before_Training.png')
...
sgtitle('TSK model 1: MFs after Training')
saveas(gcf, 'TSK_model_1_imgs/1_MFs_after_Training.png')
...
title('Representative Run (Model 1): Learning Curve');
grid on;
saveas(gcf, 'TSK_model_1_imgs/1_Learning_Curve.png');

% --- Plot prediction errors for representative run ---
figure;
plot(error_raw)
title('TSK model 1: Prediction Errors (Raw Data)')
xlabel('Sample Index')   
ylabel('Error')          
saveas(gcf,'TSK_model_1_imgs/1_Pred_Errors.png')
